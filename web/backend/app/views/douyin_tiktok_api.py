...
import logging
# 导入视频处理相关函数
from app.views.videoUpload import UPLOAD_DIR, THUMBNAIL_DIR, generate_video_thumbnail, auto_process_video
from app.models.video import VideoFile,DouyinVideo
from app.utils.extensions import db
from app.utils.HttpResponse import HttpResponse
import json
from app.views.workflow import start_video_workflow, WORKFLOW_TEMPLATES
