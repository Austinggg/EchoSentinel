...
from app.services.userAnalyse.function import (
    cal_loss,
    get_anomaly_score,
    get_feature_by_uid,
...
from app.services.userAnalyse.OLSH import find_most_similar_cluster, find_most_similar_user
...
def userAnalyse_similarCluster():
    ...
    with open("app/services/userAnalyse/olsh_index.json", "r", encoding="utf-8") as f:
