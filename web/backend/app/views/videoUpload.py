...
from app.utils.extensions import app,db
from app.utils.HttpResponse import HttpResponse, error_response, success_response
from app.views.workflow import start_video_workflow
...
def upload_video():
    ...
    try:
        ...
        for file in files:
            ...
            # 保存到数据库
            from app.utils.database import VideoFile
