...
# 引入信息提取器
from app.services.content_analysis.information_extractor import InformationExtractor
# 创建蓝图
...
def extract_from_video(file_id):
    ...
    """
    try:
        from app.utils.database import VideoFile, VideoTranscript, ContentAnalysis
        import datetime
...
def get_video_analysis(file_id):
    ...
    """
    try:
        from app.utils.database import VideoFile, ContentAnalysis
...
def generate_video_summary(file_id):
    ...
    """
    try:
        from app.utils.database import VideoFile, ContentAnalysis, VideoTranscript
        from app.services.content_analysis.summary_generator import SummaryGenerator
        import re
