...
const retestSingleStep = async (stepType) => {
  try {
    ...
    const response = await axios.post(
      `/api/videos/${videoId}/digital-human/detect`,
      {
    ...
    ElMessage.error(
      '重检失败: ' + (error.response?.data?.message || error.message),
    );
  }
};
...
const BODY_CRITERIA = [
  {
    name: '关节位置',
    description: '检查关节弯曲角度和相对位置的自然性',
    weight: 1.5,
  },

  {
    name: '手指数量',
    description: '验证手指数量的正确性和形态自然性',
    weight: 1.0,
  },

  {
    name: '面部表情',
    description: '分析面部表情的协调性和真实性',
    weight: 1.2,
  },
...
const checkDetectionStatus = async () => {
  try {
    ...
    const response = await axios.get(
      `/api/videos/${videoId}/digital-human/status`,
    );
...
const startDetection = async () => {
  try {
    ...
    detectionError.value =
      error.response?.data?.message || error.message || '启动检测失败';
...
const comprehensiveAnalysis = computed(() => {
  ...
  const finalScore =
    data.comprehensive?.human_probability * 100 || calculatedScore;
  ...
  return {
    ...
    prediction:
      data.comprehensive?.prediction ||
      (finalScore >= 50 ? 'Human' : 'AI-Generated'),
...
const bodyAnalysisDetails = computed(() => {
  ...
  return detectionData.value.body.raw_results.criteria.map((criterion) => ({
    ...
    description:
      BODY_CRITERIA.find((c) => c.name === criterion.name)?.description ||
      '详细检测标准',
...
<template>
  <div class="digital-human-container">
    ...
    <div
      v-else-if="detectionStatus === 'processing'"
      ...
      <el-card class="failed-card">
        <div class="failed-content">
          ...
          <div class="failed-actions">
            ...
            <el-button @click="checkDetectionStatus"> 刷新状态 </el-button>
          </div>
        </div>
      </el-card>
    </div>
    ...
    <div
      v-else-if="detectionStatus === 'completed' && detectionData"
          ...
          <template #header>
            <div class="card-header">
              <div class="header-left">
                ...
                <el-tag
                  v-if="detectionData.face"
                  :type="
                    detectionData.face.prediction === 'Human'
                      ? 'success'
                      : 'danger'
                  "
                >
          ...
          <div class="face-analysis">
            ...
            <div class="main-metrics">
              <el-statistic
                ...
                :value-style="{
                  color:
                    detectionData.face?.human_probability > 0.5
                      ? '#67c23a'
                      : '#f56c6c',
                }"
              />
              ...
              <el-statistic
                ...
                :value-style="{
                  color:
                    detectionData.face?.ai_probability > 0.5
                      ? '#f56c6c'
                      : '#67c23a',
                }"
              />
                ...
                <div class="image-item">
                  ...
                  <div class="image-placeholder">
                    <el-image
                      ...
                      fit="contain"
                      :preview-src-list="[
                        `/api/videos/${getVideoId()}/digital-human/face-keypoints`,
                      ]"
                ...
                <div class="image-item">
                  ...
                  <div class="image-placeholder">
                    <el-image
                      ...
                      fit="contain"
                      :preview-src-list="[
                        `/api/videos/${getVideoId()}/digital-human/face-expression`,
                      ]"
                      :hide-on-click-modal="true"
                    >
                      <template #error>
                ...
                <div class="image-item">
                  ...
                  <div class="image-placeholder">
                    <el-image
                      ...
                      fit="contain"
                      :preview-src-list="[
                        `/api/videos/${getVideoId()}/digital-human/face-texture`,
                      ]"
                      :hide-on-click-modal="true"
                    >
                      <template #error>
            ...
            <div class="algorithm-details">
              <el-descriptions :column="2" border>
                ...
                <el-descriptions-item label="检测时间">
                  {{
                    formatDateTime(
                      detectionData.face?.raw_results?.metadata?.timestamp,
                    )
                  }}
                </el-descriptions-item>
              </el-descriptions>
            ...
            <div class="risk-assessment">
              <el-progress
                type="dashboard"
                :percentage="
                  Math.round(detectionData.face?.human_probability * 100)
                "
                :status="
                  getProgressStatus(detectionData.face?.human_probability * 100)
                "
                :width="150"
              />
              ...
              <div class="risk-info">
                ...
                <div class="confidence-info">
                  ...
                  >
                    置信度:
                    {{ (detectionData.face?.confidence * 100).toFixed(1) }}%
                  </el-tag>
                </div>
              </div>
            </div>
            ...
            <div class="card-header">
              <div class="header-left">
                ...
                <el-tag
                  v-if="bodyDataFixed"
                  :type="
                    bodyDataFixed.prediction === 'Human' ? 'success' : 'danger'
                  "
                >
                  {{
                    bodyDataFixed.prediction === 'Human'
                      ? '真实躯体'
                      : 'AI生成躯体'
                  }}
                </el-tag>
          ...
          <div class="body-analysis">
            ...
            <div class="main-metrics">
              <el-statistic
                ...
                :value-style="{
                  color:
                    bodyDataFixed?.human_probability > 0.5
                      ? '#67c23a'
                      : '#f56c6c',
                }"
              />
              ...
              <el-statistic
                ...
                :value-style="{
                  color:
                    bodyDataFixed?.ai_probability > 0.5 ? '#f56c6c' : '#67c23a',
                }"
              />
            ...
            <div class="anomaly-images">
                ...
                >
                  ...
                  <div class="image-placeholder">
                    ...
                    <el-image
                      ...
                      fit="contain"
                      :preview-src-list="[
                        `/api/videos/${getVideoId()}/digital-human/anomaly-image/${item.name}`,
                      ]"
                      :hide-on-click-modal="true"
                    >
                      <template #error>
              ...
              <div
                v-if="
                  bodyAnalysisDetails.every((item) => item.response === '是')
                "
                class="no-anomaly"
              >
              ...
              >
                <template #default="scope">
                  <el-tag :type="scope.row.status">
                    <el-icon v-if="scope.row.response === '是'"
                      ><CircleCheck
                    /></el-icon>
            ...
            <div class="total-score">
              <el-progress
                type="dashboard"
                :percentage="
                  Math.round(detectionData.body?.raw_results?.total_score * 100)
                "
                :status="
                  getProgressStatus(
                    detectionData.body?.raw_results?.total_score * 100,
                  )
                "
                :width="150"
              />
          ...
          <template #header>
            <div class="card-header">
              <div class="header-left">
                ...
                <el-tag
                  v-if="detectionData.overall"
                  :type="
                    detectionData.overall.prediction === 'Human'
                      ? 'success'
                      : 'danger'
                  "
                >
          ...
          <div class="overall-analysis">
            ...
            <div class="main-metrics">
              <el-statistic
                ...
                :value-style="{
                  color:
                    detectionData.overall?.human_probability > 0.5
                      ? '#67c23a'
                      : '#f56c6c',
                }"
              />
              ...
              <el-statistic
                ...
                :value-style="{
                  color:
                    detectionData.overall?.ai_probability > 0.5
                      ? '#f56c6c'
                      : '#67c23a',
                }"
              />
                ...
                <div class="image-item">
                  ...
                  <div class="image-placeholder">
                    <el-image
                      ...
                      fit="contain"
                      :preview-src-list="[
                        `/api/videos/${getVideoId()}/digital-human/temporal-consistency`,
                      ]"
                      :hide-on-click-modal="true"
                    >
                      <template #error>
                ...
                <div class="image-item">
                  ...
                  <div class="image-placeholder">
                    <el-image
                      ...
                      fit="contain"
                      :preview-src-list="[
                        `/api/videos/${getVideoId()}/digital-human/global-texture`,
                      ]"
                      :hide-on-click-modal="true"
                    >
                      <template #error>
                ...
                <div class="image-item">
                  ...
                  <div class="image-placeholder">
                    <el-image
                      ...
                      fit="contain"
                      :preview-src-list="[
                        `/api/videos/${getVideoId()}/digital-human/generation-artifacts`,
                      ]"
                      :hide-on-click-modal="true"
                    >
                      <template #error>
                ...
                <div class="image-item">
                  ...
                  <div class="image-placeholder">
                    <el-image
                      ...
                      fit="contain"
                      :preview-src-list="[
                        `/api/videos/${getVideoId()}/digital-human/edge-consistency`,
                      ]"
                      :hide-on-click-modal="true"
                    >
                      <template #error>
            ...
            <div class="algorithm-features">
              <div class="feature-grid">
                <div class="feature-card">
                  ...
                  <p>
                    分析视频帧间的时间连续性和空间一致性，识别生成内容的时序异常
                  </p>
                </div>
            ...
            <div class="probability-distribution">
              <div class="probability-bar">
                ...
                <el-progress
                  :percentage="
                    Math.round(detectionData.overall?.ai_probability * 100)
                  "
                  status="exception"
                  :stroke-width="20"
                />
              ...
              <div class="probability-bar">
                ...
                <el-progress
                  :percentage="
                    Math.round(detectionData.overall?.human_probability * 100)
                  "
                  status="success"
                  :stroke-width="20"
                />
        ...
        <el-card class="analysis-card">
          <template #header>
            <div class="card-header">
              <div class="header-left">
                ...
                <el-tag
                  v-if="comprehensiveAnalysis"
                  :type="
                    comprehensiveAnalysis.prediction === 'Human'
                      ? 'success'
                      : 'danger'
                  "
                  size="large"
          ...
          <div class="comprehensive-analysis" v-if="comprehensiveAnalysis">
            ...
            <div class="final-result">
              ...
              <div class="result-details">
                ...
                <div class="detail-item">
                  ...
                  <span class="value"
                    >{{ comprehensiveAnalysis.confidence.toFixed(1) }}%</span
                  >
                </div>
                ...
                <div class="detail-item">
                  ...
                  <span class="value danger"
                    >{{ comprehensiveAnalysis.aiProbability.toFixed(1) }}%</span
                  >
                </div>
                ...
                <div class="detail-item">
                  ...
                  <el-tag
                    :type="
                      comprehensiveAnalysis.consensus ? 'success' : 'warning'
                    "
                  >
            ...
            <div class="component-scores">
              <div
                class="score-item"
                v-if="comprehensiveAnalysis.scores.face !== undefined"
              >
              ...
              <div
                class="score-item"
                v-if="comprehensiveAnalysis.scores.body !== undefined"
              >
                <div class="score-header">
                  <span>躯体检测得分</span>
                </div>
              ...
              <div
                class="score-item"
                v-if="comprehensiveAnalysis.scores.overall !== undefined"
              >
                <div class="score-header">
                  <span>整体检测得分</span>
                </div>
                ...
                <el-progress
                  ...
                  :status="
                    getProgressStatus(comprehensiveAnalysis.scores.overall)
                  "
                />
              </div>
            </div>
            ...
            <div class="voting-statistics">
              <div class="vote-result">
                <div class="vote-item">
                  ...
                  <span
                    >AI生成: {{ comprehensiveAnalysis.votes.ai }} 个模块</span
                  >
                </div>
                ...
                <div class="vote-item">
                  ...
                  <span
                    >真实人物:
                    {{ comprehensiveAnalysis.votes.human }} 个模块</span
                  >
                </div>
              </div>
            ...
            <div class="detection-summary">
              <el-descriptions :column="2" border>
                ...
                <el-descriptions-item label="风险等级" :span="2">
                  <el-tag
                    :type="
                      getRiskLevel(comprehensiveAnalysis.aiProbability / 100)
                        .type
                    "
                    size="large"
                  >
